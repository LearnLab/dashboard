	...
	return (
		<section className="activity">
			...
			<details className="activity-item">
				<summary>
					<img className="thumbnail" src="%PUBLIC_URL%/assets/images/icons/Followers@2x.png" alt="" />
			...
			<details className="activity-item">
				<summary>
					<img className="thumbnail" src="%PUBLIC_URL%/assets/images/icons/Events@2x.png" alt="" />
			...
			<details className="activity-item">
				<summary>
					<img className="thumbnail" src="%PUBLIC_URL%/assets/images/icons/Assignments@2x.png" alt="" />
